...
namespace Yoq.WindowsWebAuthn.Pinvoke
{
    ...
    internal class RawHmacSecretSaltOut : RawHmacSecretSalt, IDisposable
    {
        ...
        {
            if (first == null || first.Length == 0) throw new ArgumentException("first salt cannot be empty");
    ...
    internal class RawCredWithHmacSecretSalt
    {
        ...
        {
            if (credentialId == null || credentialId.Length == 0) throw new ArgumentException("credentialId cannot be empty");
    ...
    internal class RawHmacSecretSaltValues
    {
        ...
        public RawHmacSecretSaltValues(RawHmacSecretSaltOut global, RawCredWithHmacSecretSalt[] byCred)
        {
            if (global != null)
            {
